...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 29, 2024 at 05:16 AM
...
(1, b'1', '2024-06-14 16:56:31.000000', 501910.00, b'0', 'محمد', 'hkjhkjh', 0.00, 3, '2024-06-27 21:41:03.000000', 2, 1, 1, 1),
...
(6, b'1', '2024-06-27 20:53:48.000000', 0.00, b'0', 'محمد علي', 'تمام', 0.00, 3, '2024-06-27 20:53:48.000000', 3, 1, 3, 1);
...
(2, b'1', 'كفر الزيات', '2024-06-27 20:53:48.000000', 0.00, 'محمد علي', 'تمام', '0125465465', 0.00, 3, '2024-06-27 20:53:48.000000', 6, 1, 1);
...
(2, 4.00, 48.00, 0.00, b'1', 4.00, 'qwe', 12.00, 1.00, NULL, b'1', 12.00, 12.00, b'0', 1, 'لفة سلك نحاس', 12.00, 12.00, NULL, 12.00, 12.00, 12.00, '2024-06-28 00:54:17.000000', 1, NULL, NULL, 2, 1, 1),
(8, 16.00, 192.00, 0.00, b'1', 16.00, 'qwe', 12.00, 1.00, '2024-06-14 19:13:06.000000', b'1', 12.00, 12.00, b'0', 1, 'بكرة سلوك', 12.00, 12.00, NULL, 12.00, 12.00, 12.00, '2024-06-28 01:09:50.000000', 1, 1, NULL, 2, 1, 1),
...
(21, 'نظير مشتريات من المورد  محمد فاتورة رقم 4', 'عدد  19.00 كرتونة', 'عدد  4.00 كرتونة', 'عدد  null كرتونة', 'عدد  15.00 كرتونة', 1, 1, 8, 2),
(22, 'نظير مبيعات  للعميل  علي سعد فاتورة رقم 2', 'عدد  4.00 كرتونة', 'عدد  4.00 كرتونة', 'عدد  6.00 كرتونة', 'عدد  6.00 كرتونة', 2, 4, 2, 1),
(23, 'نظير مبيعات  للعميل  علي سعد فاتورة رقم 2', 'عدد  16.00 كرتونة', 'عدد  12.00 كرتونة', 'عدد  15.00 كرتونة', 'عدد  19.00 كرتونة', 2, 4, 8, 1);
...
(1, '2024-06-28 00:54:16.000000', '2024-06-28', 1, b'1', '2024-06-28', 2.0000, 1, 24.00, 12.00, '2024-06-28 00:54:16.000000', 1, 13, 2, 2, 1, 1, 1),
(2, '2024-06-28 01:09:50.000000', '2024-06-28', 1, b'1', '2024-06-28', 3.0000, 1, 36.00, 12.00, '2024-06-28 01:09:50.000000', 1, 10, 8, 2, 1, 1, 1);
...
(1, b'1', 'kjh', '2024-06-14 16:56:31.000000', 501910.00, 'محمد', 'hkjhkjh', '987987987', 0.00, 3, '2024-06-27 21:41:03.000000', 1, 1, 1, 1);
...
(1, NULL, '2024-06-22 19:18:04.000000', NULL, 2, 0.00, '1234', b'0', -96.00, 'asd', '2024-06-22', 1, 2, NULL, NULL, NULL, NULL, 212.00, 212.00, 0.00, NULL, '2024-06-28 01:07:23.000000', 90.00, 0.00, 1, 1, NULL, 1, 1, 1),
(2, NULL, '2024-06-27 20:49:31.000000', NULL, NULL, 0.00, '654', b'0', -36.00, 'ok', '2024-06-27', 1, 1, NULL, NULL, NULL, NULL, 36.00, 36.00, 0.00, NULL, '2024-06-27 20:51:33.000000', 30.00, NULL, 1, 1, NULL, 1, 1, 1),
(3, NULL, '2024-06-27 21:20:15.000000', NULL, NULL, 0.00, '456', b'0', -48.00, 'ثقف', '2024-06-27', 1, 1, NULL, NULL, NULL, NULL, 48.00, 48.00, 0.00, NULL, '2024-06-27 21:20:36.000000', 48.00, NULL, 1, 1, NULL, 2, 1, 1),
(4, NULL, '2024-06-27 21:21:26.000000', NULL, 0, 0.00, '789', b'1', -48.00, 'غعه', '2024-06-27', 1, 1, NULL, NULL, NULL, NULL, 48.00, 48.00, 0.00, NULL, '2024-06-27 21:41:03.000000', 48.00, 0.00, 1, 1, NULL, 2, 1, 1),
(5, NULL, '2024-06-28 01:07:39.000000', NULL, NULL, 0.00, '234', b'0', NULL, 'sdf', '2024-06-28', 1, 1, NULL, NULL, 0.00, NULL, 24.00, 24.00, 0.00, NULL, '2024-06-28 01:07:45.000000', NULL, NULL, 1, 1, NULL, 1, 1, 1);
...
INSERT INTO `suppliers_with_orders_details` (`id`, `batch_auto_serial`, `created_at`, `deliverd_quantity`, `expire_date`, `isparentuom`, `item_card_type`, `order_type`, `production_date`, `total_price`, `unit_price`, `updated_at`, `added_by`, `inv_item_id`, `order_id`, `uom_id`, `updated_by`, `order_return_id`) VALUES
(1, 1, '2024-06-22 19:18:13.000000', 6.00, NULL, b'1', 1, 1, NULL, 72.00, 12.00, '2024-06-28 01:07:23.000000', 1, 2, 1, 1, 1, NULL),
(5, 1, '2024-06-22 19:34:52.000000', 2.00, NULL, b'1', 1, 1, NULL, 24.00, 12.00, '2024-06-22 19:34:52.000000', 1, 9, 1, 1, 1, NULL),
(6, 1, '2024-06-22 19:35:43.000000', 2.00, NULL, b'1', 1, 1, NULL, 24.00, 12.00, '2024-06-22 19:35:43.000000', 1, 10, 1, 2, 1, NULL),
(7, 1, '2024-06-23 14:49:38.000000', 4.00, NULL, b'1', 1, 1, NULL, 92.00, 23.00, '2024-06-23 14:50:15.000000', 1, 8, 1, 1, 1, NULL),
(8, 1, '2024-06-27 20:49:41.000000', 1.00, NULL, b'1', 1, 1, NULL, 12.00, 12.00, '2024-06-27 20:49:41.000000', 1, 2, 2, 2, 1, NULL),
(9, 1, '2024-06-27 20:49:52.000000', 2.00, NULL, b'1', 1, 1, NULL, 24.00, 12.00, '2024-06-27 20:49:52.000000', 1, 9, 2, 1, 1, NULL),
(10, 1, '2024-06-27 21:20:25.000000', 4.00, NULL, b'1', 1, 1, NULL, 48.00, 12.00, '2024-06-27 21:20:25.000000', 1, 2, 3, 2, 1, NULL),
(11, 1, '2024-06-27 21:21:51.000000', 4.00, NULL, b'1', 1, 1, NULL, 48.00, 12.00, '2024-06-27 21:21:51.000000', 1, 8, 4, 1, 1, NULL),
(12, 1, '2024-06-28 01:07:45.000000', 2.00, NULL, b'1', 1, 1, NULL, 24.00, 12.00, '2024-06-28 01:07:45.000000', 1, 2, 5, 1, 1, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `suppliers_with_orders_return`
--

CREATE TABLE `suppliers_with_orders_return` (
  `id` bigint(20) NOT NULL,
  `auto_serial` bigint(20) DEFAULT NULL,
  `created_at` datetime(6) DEFAULT NULL,
  `discount_percent` decimal(10,2) DEFAULT NULL,
...
--
-- Table structure for table `suppliers_with_orders_return_details`
--

CREATE TABLE `suppliers_with_orders_return_details` (
  `id` bigint(20) NOT NULL,
  `batch_auto_serial` bigint(20) DEFAULT NULL,
  `created_at` datetime(6) NOT NULL,
  `deliverd_quantity` decimal(10,2) NOT NULL,
...
(1, '2024-06-22 15:35:03.000000', b'1', b'1', 1, 18, 'الرئيسية', '2024-06-27 21:41:03.000000', 1, 1);
...
(18, 'صرف نظير فاتورة مشتريات  رقم4', '2024-06-27 21:41:02.000000', b'1', b'1', 1, 48.00, 48.00, 9, '2024-06-27', 1, NULL, '2024-06-27 21:41:02.000000', 1, 1, 1, 1);
...
ALTER TABLE `sales_invoices_details`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UK_my9kyqcdxwgce45qs6wrmnd8o` (`item_code`),
...
ALTER TABLE `suppliers_with_orders_details`
  ...
  ADD KEY `FK29g758wqs8tts5fmjfdq505wp` (`order_return_id`);

--
-- Indexes for table `suppliers_with_orders_return`
--
ALTER TABLE `suppliers_with_orders_return`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FKglx6ihhxwfcmjyyyxtwvlqrx` (`account_number`),
  ADD KEY `FKdp5x7xxfu97jaqx98so4ugd2k` (`added_by`),
  ADD KEY `FKkqkvoiw1sk24wwi8l564vln2y` (`approved_by`),
  ADD KEY `FK831atcustnh189thkmuae2mhu` (`store_id`),
  ADD KEY `FK359axmrbp2gb0whrtemp2v7v7` (`supplier_id`),
  ADD KEY `FKf916lohu8n45ww1dkmpu0h4m0` (`updated_by`);

--
-- Indexes for table `suppliers_with_orders_return_details`
--
ALTER TABLE `suppliers_with_orders_return_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK29ydo2dod95cxelpa2baw6rju` (`added_by`),
  ADD KEY `FKctin3jho71vh4um52x94vo9qd` (`inv_item_id`),
  ADD KEY `FKn1p7p43n06igfh6km5akahvde` (`order_return_id`),
  ADD KEY `FK5tdhm6f9olo7yv9go7xs9lcd6` (`uom_id`),
  ADD KEY `FK6tnb7p7x2uk0l7ocombisu6s8` (`updated_by`);
...
--
-- AUTO_INCREMENT for table `suppliers_with_orders_return`
--
ALTER TABLE `suppliers_with_orders_return`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `suppliers_with_orders_return_details`
--
ALTER TABLE `suppliers_with_orders_return_details`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `suppliers_with_orders_details`
  ADD CONSTRAINT `FK29g758wqs8tts5fmjfdq505wp` FOREIGN KEY (`order_return_id`) REFERENCES `suppliers_with_orders_return` (`id`),
...
--
-- Constraints for table `suppliers_with_orders_return`
--
ALTER TABLE `suppliers_with_orders_return`
  ADD CONSTRAINT `FK359axmrbp2gb0whrtemp2v7v7` FOREIGN KEY (`supplier_id`) REFERENCES `suppliers` (`id`),
  ADD CONSTRAINT `FK831atcustnh189thkmuae2mhu` FOREIGN KEY (`store_id`) REFERENCES `stores` (`id`),
  ADD CONSTRAINT `FKdp5x7xxfu97jaqx98so4ugd2k` FOREIGN KEY (`added_by`) REFERENCES `admins` (`id`),
  ADD CONSTRAINT `FKf916lohu8n45ww1dkmpu0h4m0` FOREIGN KEY (`updated_by`) REFERENCES `admins` (`id`),
  ADD CONSTRAINT `FKglx6ihhxwfcmjyyyxtwvlqrx` FOREIGN KEY (`account_number`) REFERENCES `accounts` (`id`),
  ADD CONSTRAINT `FKkqkvoiw1sk24wwi8l564vln2y` FOREIGN KEY (`approved_by`) REFERENCES `admins` (`id`);

--
-- Constraints for table `suppliers_with_orders_return_details`
--
ALTER TABLE `suppliers_with_orders_return_details`
  ADD CONSTRAINT `FK29ydo2dod95cxelpa2baw6rju` FOREIGN KEY (`added_by`) REFERENCES `admins` (`id`),
  ADD CONSTRAINT `FK5tdhm6f9olo7yv9go7xs9lcd6` FOREIGN KEY (`uom_id`) REFERENCES `inv_uoms` (`id`),
  ADD CONSTRAINT `FK6tnb7p7x2uk0l7ocombisu6s8` FOREIGN KEY (`updated_by`) REFERENCES `admins` (`id`),
  ADD CONSTRAINT `FKctin3jho71vh4um52x94vo9qd` FOREIGN KEY (`inv_item_id`) REFERENCES `inv_itemcard` (`id`),
  ADD CONSTRAINT `FKn1p7p43n06igfh6km5akahvde` FOREIGN KEY (`order_return_id`) REFERENCES `suppliers_with_orders_return` (`id`);
