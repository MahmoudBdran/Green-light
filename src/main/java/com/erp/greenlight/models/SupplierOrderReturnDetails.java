...
@Setter
@Getter
@Table(name = "suppliers_with_orders_return_details")
@EntityListeners({AuditingEntityListener.class})
public class SupplierOrderReturnDetails {
    ...
    @JsonIgnore
    private SupplierOrderReturn orderReturn;  // Foreign key referencing SupplierOrder
